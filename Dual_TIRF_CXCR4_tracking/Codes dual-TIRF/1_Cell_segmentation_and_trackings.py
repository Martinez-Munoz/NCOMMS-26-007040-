...
folder_name = os.path.normpath(r"/Volumes/Laura 2023/22-06-2023 CXCR4Rab4a")
...
experiment_to_analyze = "Experiment1"  # Set to "experiment1" or None for all
condition_to_analyze = "CTL"   # Set to "KO" or None for all
